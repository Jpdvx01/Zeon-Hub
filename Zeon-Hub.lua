if game.CoreGui:FindFirstChild("Zeon_Hub") then
    game.CoreGui:FindFirstChild("Zeon_Hub"):Destroy()
end

local ZEONUIMODILE = Instance.new("ScreenGui")
local MODILEGUIZEONUI = Instance.new("TextButton")
local MODILEGUIZEONUIHUI = Instance.new("UICorner")
local MODILEMAGE = Instance.new("ImageLabel")

ZEONUIMODILE.Name = "Zeon_Hub"
ZEONUIMODILE.Parent = game.CoreGui
ZEONUIMODILE.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

MODILEGUIZEONUI.Name = "MODILEGUIZEONUI"
MODILEGUIZEONUI.Parent = ZEONUIMODILE
MODILEGUIZEONUI.BackgroundColor3 = Color3.fromRGB(50,20,20)
MODILEGUIZEONUI.BorderSizePixel = 0
MODILEGUIZEONUI.Position = UDim2.new(0.120833337, 0, 0.0952890813, 0)
MODILEGUIZEONUI.Size = UDim2.new(0, 50, 0, 50)
MODILEGUIZEONUI.Font = Enum.Font.SourceSans
MODILEGUIZEONUI.Text = "X"
MODILEGUIZEONUI.TextColor3 = Color3.fromRGB(255, 255, 255)
MODILEGUIZEONUI.TextSize = 14.000
MODILEGUIZEONUI.Draggable = true
MODILEGUIZEONUI.MouseButton1Click:Connect(function()
    game.CoreGui:FindFirstChild("ZEONUI").Enabled = not game.CoreGui:FindFirstChild("ZEONUI").Enabled
end)
do
    if game:GetService("CoreGui"):FindFirstChild("ZEONUI") then
    end
end

do local GUI = game.CoreGui:FindFirstChild("ZEONUI");if GUI then GUI:Destroy();end;if _G.Color == nil then
...
function Update:Window(text,logo,keybind)
    ...
    ZEONUI.Name = "ZEONUI"
    ZEONUI.Parent = game.CoreGui
    ZEONUI.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
    ...
    Hub.Name = "Hub"
    Hub.Parent = Top
    Hub.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
    ...
    Hubb.Name = "Hub"
    Hubb.Parent = Top
    Hubb.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
    ...
    function uitab:Tab(text,image)
        ...
        function main:Toggle(text,config,callback)
            ...
            Circle.BackgroundColor3 = Color3.fromRGB(60, 222, 222)
            ...
            Button.MouseButton1Click:Connect(function()
                if toggled == false then
                    ...
                    TweenService:Create(
                            Circle,
                            TweenInfo.new(0.4,Enum.EasingStyle.Quad,Enum.EasingDirection.Out),
                            {BackgroundColor3 = Color3.fromRGB(60, 212, 227)}
                    ):Play()
                end
...
function InfAb()
    if InfAbility then
        if not game:GetService("Players").LocalPlayer.Character.HumanoidRootPart:FindFirstChild("Agility") then
            ...
            inf.RotSpeed = NumberRange.new(1000, 1000)
            inf.Rotation = NumberRange.new(0, 0)
            inf.Speed = NumberRange.new(17, 17)
...
function fly()
    ...
    local function start()
        ...
        repeat
            ...
            pos.position=new.p
            if keys.w then
                gyro.CFrame = workspace.CurrentCamera.CoordinateFrame*CFrame.Angles(-math.rad(speed*10),0,0)
            elseif keys.s then
                gyro.CFrame = workspace.CurrentCamera.CoordinateFrame*CFrame.Angles(math.rad(speed*10),0,0)
            else
...
local Library = Update:Window("Zeon","9199672495",Enum.KeyCode.RightControl);
...
Main:Seperator("Welcome To Zeon Hub")

Main:Button("Go to Discord",function()
                ...
                elseif game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                    ...
                    if game:GetService("Workspace").Enemies:FindFirstChild(Mon) then
                        ...
                        if game:GetService("ReplicatedStorage"):FindFirstChild(Mon) then
                            TP1(game:GetService("ReplicatedStorage"):FindFirstChild(Mon).HumanoidRootPart.CFrame * CFrame.new(5,10,2))
                        else
                            if (CFrameQuest.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 0 then
                                if PosMon ~= nil then
                                    TP1(PosMon * CFrame.new(5,10,2))
                                else
                                    if OldPos ~= nil then
                                        TP1(OldPos.Position)
                                    end
